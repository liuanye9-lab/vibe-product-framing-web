  ...
  return (
    <div className="vp-card" style={{ marginBottom: 18, borderColor: 'var(--color-primary)', boxShadow: '0 18px 50px rgba(79, 70, 229, 0.12)' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
        ...
        {onSimplify && <button className="vp-btn vp-btn-ghost" onClick={onSimplify} disabled={loading}>{loading ? <Loader2 size={14} className="vp-spin" /> : <RefreshCw size={14} />} 换一个更简单版本</button>}
